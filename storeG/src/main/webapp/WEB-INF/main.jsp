...
<div class="top">
	<img class="slide" src="img/main/lostark.jpg"> <img class="slide"
		src="img/main/onepiece.jpg"> <img class="slide"
		src="img/main/overwatch.jpg"> <img class="slide"
		src="img/main/poketmon.jpg"> <img class="slide"
		src="img/main/silva.jpg"> <img class="slide"
		src="img/main/titan.jpg">
		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
			<c:forEach var="nlist" items="${nList}">
				...
				<div class="col col-sm-6 col-md-3">
					<a href="${ctx}/product.do?itemNo=${nlist.itemNo}"
	...
	<div class="popular">
		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
			<c:forEach var="plist" items="${pList}">
				...
				<div class="col col-sm-6 col-md-3">
					<a href="${ctx}/product.do?itemNo=${plist.itemNo}"
						style="text-decoration: none">
						<div class="card shadow-sm">
							<div
								style="width: 100%; display: flex; justify-content: center; align-items: center;">
								<img src="${ctx}/img/${ifolder}/${plist.img}" alt="Alt Text"
									class="img-fluid">
							</div>
							<div class="card-body">
